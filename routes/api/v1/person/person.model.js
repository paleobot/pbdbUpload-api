...
export const createPerson = async (pool, person, user) => {
    logger.info("createPerson");
    logger.trace(person);

    const insertAssets = prepareInsertAssets(reference);
    //TODO: Other extra stuff for person? Similar to these for refs:
	...
	const insertSQL = `insert into person (${insertAssets.propStr}) values (${insertAssets.valStr})`
